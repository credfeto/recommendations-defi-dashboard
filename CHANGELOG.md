...
- Dependabot auto-approve workflow now inlines scripts instead of referencing local composite actions, which cannot be resolved in pull_request_target workflows before checkout runs
