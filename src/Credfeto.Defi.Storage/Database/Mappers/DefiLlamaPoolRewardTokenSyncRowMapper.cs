...
internal sealed class DefiLlamaPoolRewardTokenSyncRowMapper : IMapper<IReadOnlyList<DefiLlamaPoolTokenSyncRow>>
{
    private const string TABLE_TYPE = "DefiLlama.PoolRewardTokenRow";
